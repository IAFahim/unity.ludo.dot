...
namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string AndroidPackageName = "com.zooshaus.ludostarsclub";
        public static string ITunesAppID = "11111111111";



        // Notifications
        public static string notificationTitle = "com.zooshaus.ludostarsclub";
        ...
        public static string PlayFabTitleID = "6355B";
        public static string PhotonAppID = "65d4add8-b9a8-4bcf-95a9-951d5de853f6";
        public static string PhotonChatID = "39757a3d-ed7d-499f-9586-72c0154bc667";
        ...
        public static string facebookShareLinkTitle = "I'm playing Super Ludo World. Available on Android and iOS.";

        // Share private room code
        public static string SharePrivateLinkMessage = "Join me in Ludo With Friends. My PRIVATE ROOM CODE is:";
        public static string SharePrivateLinkMessage2 = "Download Ludo With Friends:";
        ...
        public static int initCoinsCountGuest = 3000;
